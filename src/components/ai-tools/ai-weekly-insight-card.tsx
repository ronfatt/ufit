...
export function AIWeeklyInsightCard({ profile }: { profile: DemoProfile }) {
  ...
  return (
    <AIToolShell
      ...
      subtitle="Smart analysis of your wellness habits."
      accentClass="shadow-[0_0_70px_rgba(124,58,237,0.16)]"
      triggerLabel="View Insight Report"
    >
      <div className="space-y-5">
        <div className="text-lg font-bold text-white">Your Weekly Insight Report</div>
